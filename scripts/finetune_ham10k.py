...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data_path", type=str, default='/usr/local/data/zahrat/workshop/dent/data/ham10k_metadata.csv')
    parser.add_argument("--image_root_path", type=str, default='/usr/local/faststorage/datasets/zahrat/ham10000')
    parser.add_argument("--output_dir", type=str, default='/usr/local/data/zahrat/workshop/stable-diffusion-finetune/saved_models/ham10k-finetuned-sd1-5')
