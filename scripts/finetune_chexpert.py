...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data_path", type=str, default='/home/amarkr/dent/data/chexpert/chexpert_train.csv')
    parser.add_argument("--image_root_path", type=str, default='/home/jupyter')
    parser.add_argument("--output_dir", type=str, default='saved_models/finetuned_chexpert_19Feb')
